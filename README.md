...
The additional dependecy are [samtools](http://www.htslib.org/doc/samtools.html), python `random` and `subprocess` libraries and a the human reference genome sequence that you dowloand from [ensambl](https://grch37.ensembl.org/index.html) ftp server:`ftp://ftp.ensembl.org/pub/grch37/current/fasta/homo_sapiens/dna/`
