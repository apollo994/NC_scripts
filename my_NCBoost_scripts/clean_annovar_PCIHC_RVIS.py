...
def update_PCICH_intergenic(closest_gene, chrom, pos, ref, alt, PC_count_dict) :
        ...
        if ((len(ref) > 1) or (len(alt) > 1)):
            ...
            if any(re.findall(r'exonic|splicing|ncRNA', annovar_annotation, re.IGNORECASE)):
              ...
              pass
                ...
                updated_gene = update_PCICH_intergenic(closest_gene_name, chrom, pos, ref, alt, PC_count_dict)
                # if the gene comes from reassignment in the result there is
                # also PC_count_dict to be extracted
                if isinstance(updated_gene, list):
                    temp_list=updated_gene
                    updated_gene=temp_list[0]
                    PC_count_dict=temp_list[1]
