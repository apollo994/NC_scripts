...
python3.6.1 my_NCBoost_scripts/clean_annovar.py $anno_out.variant_function $anno_out.invalid_input $anno_out.cleaned_variant_function  $PCth $path_to_PCHIC/PCHIC_for_NC.txt
