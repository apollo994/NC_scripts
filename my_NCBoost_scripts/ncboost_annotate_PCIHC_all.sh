...
python3.6.1 NCBoost_scripts/clean_annovar_PCIHC_all.py $anno_out.variant_function $anno_out.invalid_input $anno_out.cleaned_variant_function  $PCth $path_to_PCHIC/all_PCHIC_for_NC.txt
