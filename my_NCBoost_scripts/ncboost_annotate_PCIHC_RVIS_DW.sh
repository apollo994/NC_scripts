...
python3.6.1 NCBoost_scripts/clean_annovar_PCIHC_RVIS_DW.py $anno_out.variant_function $anno_out.invalid_input $anno_out.cleaned_variant_function  $PCth $path_to_PCHIC/PCHIC_for_NC.txt
...
/software/R-3.4.2/bin/Rscript NCBoost_scripts/NCBoost_score.R $anno_out'_complete.tsv' $outF $n_rows_in_file $n_columns_in_file
